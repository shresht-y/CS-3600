# Credits: https://github.com/fastai/course-v3/tree/master/nbs/dl2͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏️͏︌͏󠄃
...
def notebook2scriptSingle(fname, destination):
    ...
    module = f'''
#################################################
### THIS FILE WAS AUTOGENERATED! DO NOT EDIT! ###͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏️͏︌͏󠄃
#################################################
# file to edit: {fname}͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏️͏︌͏󠄃
...
'''
    ...
    # remove trailing spaces͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏️͏︌͏󠄃
